...
def query_sequence_explorer_protein(cursor, edge_list_file, tmp_dir, result_dir):
...
if __name__ == "__main__":
    ...
    query_sequence_explorer_protein(cursor, args.edge_list_file, args.tmp_dir, args.result_dir)
